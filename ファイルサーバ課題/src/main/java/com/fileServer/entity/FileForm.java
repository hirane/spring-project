...
public class FileForm {
	...
	/**
	 * 現在閲覧しているディレクトリ階層、もしくは画面移動先ディレクトリ階層
	 */
	...
	/**
	 * ファイル名・フォルダ名リネーム時の新しいファイル名・新しいフォルダ名
	 */
	@NotBlank
	@Pattern(regexp = "[^\\\\/:*?\"<>|]*", message = "「\\ / : * ? \" < > |」は名前に使用できません。")
	...
	/**
	 * 上部階層表示で"Top"表示用、もしくは不正パラメータインプット時にトップ画面へ戻すための値
	 */
